create or replace PACKAGE "EDW_STUDENT_DIM_ACAD_TIME"  AS

-- Map Generation Timestamp
get_generation_date      VARCHAR2(100) := 'Fri Jan 31 15:46:16 MST 2014';
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'F14CC01227567D66E040F00AA4443159';
get_model_name                CONSTANT VARCHAR2(40) := '"EDW_STUDENT_DIM_ACAD_TIME"';
...
"C2_0_S0" VARCHAR2(120) := 'STUDENT'; -- ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS
...
-- Function Main -- Entry point in package "EDW_STUDENT_DIM_ACAD_TIME"
--------------------------------------------------
...
END "EDW_STUDENT_DIM_ACAD_TIME";
/
create or replace PACKAGE BODY "EDW_STUDENT_DIM_ACAD_TIME" AS
...
/* OPERATOR PIVOT: TRANSFORM */
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_WV" END "ACADEMIC_PERIOD_WV",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_SD" END "ACADEMIC_PERIOD_SD$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_LD" END "ACADEMIC_PERIOD_LD$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACAD_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACAD_PERIOD_BEGIN_DATE" END "ACADEMIC_PERIOD_BEGIN_DATE$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACAD_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACAD_PERIOD_END_DATE" END "ACADEMIC_PERIOD_END_DATE$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_WV" END "ACADEMIC_YEAR_WV",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_SD" END "ACADEMIC_YEAR_SD$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_LD" END "ACADEMIC_YEAR_LD$1"
FROM
  (SELECT
  0 "ID"
FROM
...
FROM
  ...
  (SELECT
/*+ PARALLEL ("WTT_STUDENT_CLEAN", 8 ) */
/* WTT_STUDENT_CLEAN.INOUTGRP1 */
  "WTT_STUDENT_CLEAN"."ACADEMIC_PERIOD_WV" "ACADEMIC_PERIOD_WV",
  "WTT_STUDENT_CLEAN"."ACADEMIC_PERIOD_SD" "ACADEMIC_PERIOD_SD",
  "WTT_STUDENT_CLEAN"."ACADEMIC_PERIOD_LD" "ACADEMIC_PERIOD_LD",
  "WTT_STUDENT_CLEAN"."ACADEMIC_PERIOD_BEGIN_DATE" "ACADEMIC_PERIOD_BEGIN_DATE",
  "WTT_STUDENT_CLEAN"."ACADEMIC_PERIOD_END_DATE" "ACADEMIC_PERIOD_END_DATE",
  "WTT_STUDENT_CLEAN"."ACADEMIC_YEAR_WV" "ACADEMIC_YEAR_WV",
  "WTT_STUDENT_CLEAN"."ACADEMIC_YEAR_SD" "ACADEMIC_YEAR_SD",
  "WTT_STUDENT_CLEAN"."ACADEMIC_YEAR_LD" "ACADEMIC_YEAR_LD",
  "WTT_STUDENT_CLEAN"."APFA_ACADEMIC_PERIOD_WV" "APFA_ACADEMIC_PERIOD_WV",
  "WTT_STUDENT_CLEAN"."APFA_ACADEMIC_PERIOD_SD" "APFA_ACADEMIC_PERIOD_SD",
  "WTT_STUDENT_CLEAN"."APFA_ACADEMIC_PERIOD_LD" "APFA_ACADEMIC_PERIOD_LD",
  "WTT_STUDENT_CLEAN"."APFA_ACAD_PERIOD_BEGIN_DATE" "APFA_ACAD_PERIOD_BEGIN_DATE",
  "WTT_STUDENT_CLEAN"."APFA_ACAD_PERIOD_END_DATE" "APFA_ACAD_PERIOD_END_DATE",
  "WTT_STUDENT_CLEAN"."APFA_ACADEMIC_YEAR_WV" "APFA_ACADEMIC_YEAR_WV",
  "WTT_STUDENT_CLEAN"."APFA_ACADEMIC_YEAR_SD" "APFA_ACADEMIC_YEAR_SD",
  "WTT_STUDENT_CLEAN"."APFA_ACADEMIC_YEAR_LD" "APFA_ACADEMIC_YEAR_LD",
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_PERIOD_WV" "APLA_ACADEMIC_PERIOD_WV",
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_PERIOD_SD" "APLA_ACADEMIC_PERIOD_SD",
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_PERIOD_LD" "APLA_ACADEMIC_PERIOD_LD",
  "WTT_STUDENT_CLEAN"."APLA_ACAD_PERIOD_BEGIN_DATE" "APLA_ACAD_PERIOD_BEGIN_DATE",
  "WTT_STUDENT_CLEAN"."APLA_ACAD_PERIOD_END_DATE" "APLA_ACAD_PERIOD_END_DATE",
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_YEAR_WV" "APLA_ACADEMIC_YEAR_WV",
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_YEAR_SD" "APLA_ACADEMIC_YEAR_SD",
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_YEAR_LD" "APLA_ACADEMIC_YEAR_LD"
FROM
  "EDWSTG"."WTT_STUDENT_CLEAN"  "WTT_STUDENT_CLEAN") "PIVOT_SOURCE" /* OPERATOR PIVOT */) "PIVOT" 
...
FROM
  (SELECT
/* OPERATOR PIVOT: TRANSFORM */
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_WV" END "ACADEMIC_PERIOD_WV$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_SD" END "ACADEMIC_PERIOD_SD$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_LD" END "ACADEMIC_PERIOD_LD$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACAD_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACAD_PERIOD_BEGIN_DATE" END "ACADEMIC_PERIOD_BEGIN_DATE$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACAD_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACAD_PERIOD_END_DATE" END "ACADEMIC_PERIOD_END_DATE$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_WV" END "ACADEMIC_YEAR_WV$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_SD" END "ACADEMIC_YEAR_SD$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_LD" END "ACADEMIC_YEAR_LD$3"
FROM
  (SELECT
  0 "ID"
FROM
...
/* WTT_STUDENT_CLEAN.INOUTGRP1 */
  ...
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_YEAR_LD" "APLA_ACADEMIC_YEAR_LD"
FROM
  "EDWSTG"."WTT_STUDENT_CLEAN"  "WTT_STUDENT_CLEAN") "PIVOT_SOURCE" /* OPERATOR PIVOT */) "PIVOT$1" 
MINUS /* OPERATOR SET_OPERATION */
SELECT
/* WDT_ACADEMIC_TIME_1.INOUTGRP1 */
  "WDT_ACADEMIC_TIME_1"."ACADEMIC_PERIOD" "ACADEMIC_PERIOD",
...
BEGIN
  ...
  get_abort_procedure := FALSE;
    ...
    batch_auditd_id := OWBSYS.WB_RT_MAPAUDIT.auditd_begin(  -- Template BatchAuditDetailBegin
      ...
      p_target_uoid=>'F14CC012282A7D66E040F00AA4443159',
    ...
    p_parent_operator_uoid=>'DC07F30AA9BD08DBE043562518958739', -- Operator WCV_DEFAULT_VALUES
    ...
    p_location_uoid=>'ADA0B2222EF50292E040189556257D87' -- EDWSTG_LOCATION
    	...
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'F14CC012282A7D66E040F00AA4443159', -- Operator WDT_ACADEMIC_TIME
    ...
    p_location_uoid=>'F085808747B70042E040F00AA4445414' -- Location EDWMGR_LOCATION
    	...
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'97E649F3776D32B5E0440003BAAC9CF3', -- Operator WTT_STUDENT_CLEAN
    p_parent_object_name=>'WTT_STUDENT_CLEAN',
    p_parent_object_uoid=>'8FA5A544318014E8E0440003BAAC9CF3', -- Table WTT_STUDENT_CLEAN
    p_parent_object_type=>'Table',
    p_object_name=>'WTT_STUDENT_CLEAN',
    p_object_uoid=>'8FA5A544318014E8E0440003BAAC9CF3', -- Table WTT_STUDENT_CLEAN
    p_object_type=>'Table',
    p_location_uoid=>'8848749C75B34564E0440003BAAC9CF3' -- EDWSTG_LOCATION
  );
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'F14CC01228137D66E040F00AA4443159', -- Operator WCV_DEFAULT_VALUES
    p_parent_object_name=>'WCV_DEFAULT_VALUES',
    ...
    p_location_uoid=>'F085808747D20042E040F00AA4445414' -- Location EDWSTG_LOCATION
    	...
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'F14CC01228A27D66E040F00AA4443159', -- Operator WTT_STUDENT_CLEAN
    p_parent_object_name=>'WTT_STUDENT_CLEAN',
    p_parent_object_uoid=>'F085A9588A409205E040F00AA444128A', -- Table WTT_STUDENT_CLEAN
    p_parent_object_type=>'Table',
    p_object_name=>'WTT_STUDENT_CLEAN',
    p_object_uoid=>'F085A9588A409205E040F00AA444128A', -- Table WTT_STUDENT_CLEAN
    p_object_type=>'Table',
    p_location_uoid=>'F085808747D20042E040F00AA4445414' -- Location EDWSTG_LOCATION
  );
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
...
MERGE
/*+ MERGE ("WDT_ACADEMIC_TIME") PARALLEL ("WDT_ACADEMIC_TIME") APPEND  */
INTO
...
/* JOINER.OUTGRP1 */
  ...
  "WCV_DEFAULT_VALUES"."NULL_CLEANSE_SHORT" "USER_ATTRIBUTE_05_SD",
  "WCV_DEFAULT_VALUES"."NULL_CLEANSE_LONG" "USER_ATTRIBUTE_05_LD",
  "EDW_STUDENT_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */ "SYSTEM_LOAD_PROCESS",
...
FROM
  (SELECT
/* OPERATOR PIVOT: TRANSFORM */
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_WV" END "ACADEMIC_PERIOD_WV$2",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_SD" END "ACADEMIC_PERIOD_SD$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_PERIOD_LD" END "ACADEMIC_PERIOD_LD$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACAD_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACAD_PERIOD_BEGIN_DATE" END "ACADEMIC_PERIOD_BEGIN_DATE$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACAD_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACAD_PERIOD_END_DATE" END "ACADEMIC_PERIOD_END_DATE$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_WV" END "ACADEMIC_YEAR_WV$2",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_SD" END "ACADEMIC_YEAR_SD$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."APFA_ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."APLA_ACADEMIC_YEAR_LD" END "ACADEMIC_YEAR_LD$6"
FROM
  (SELECT
  0 "ID"
FROM
...
/* WTT_STUDENT_CLEAN.INOUTGRP1 */
  ...
  "WTT_STUDENT_CLEAN"."APLA_ACADEMIC_YEAR_LD" "APLA_ACADEMIC_YEAR_LD"
FROM
  "EDWSTG"."WTT_STUDENT_CLEAN"  "WTT_STUDENT_CLEAN") "PIVOT_SOURCE" /* OPERATOR PIVOT */) "PIVOT$2" 
MINUS /* OPERATOR SET_OPERATION */
SELECT
/* WDT_ACADEMIC_TIME_1.INOUTGRP1 */
  "WDT_ACADEMIC_TIME_1"."ACADEMIC_PERIOD" "ACADEMIC_PERIOD",
...
IF NOT batch_exception AND NOT get_no_commit THEN
      ...
      IF actual_name IS NOT NULL THEN
        ...
        IF (batch_inserted + batch_merged) >= get_map_num_rows THEN
          ...
          "EDW_STUDENT_DIM_ACAD_TIME".tables_to_analyze(
        "EDW_STUDENT_DIM_ACAD_TIME".tables_to_analyze.COUNT + 1) := a_table_to_analyze;
        END IF;
      END IF;
    END IF;
...
get_source_name            CONSTANT VARCHAR2(2000) := SUBSTRB('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_CLEAN"',0,2000);
get_source_uoid            CONSTANT VARCHAR2(2000) := SUBSTRB('F14CC01228137D66E040F00AA4443159',0,2000);
...
TYPE "T_J1_45_A4" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
...
BEGIN
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_seq=>1,
    p_instance=>1,
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_CLEAN"',0,80),
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_45_A4"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
...
get_target_name := '"WDT_ACADEMIC_TIME"';
            ...
            "J1_45_A4"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_8_A4"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_45_A4"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "EDW_STUDENT_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */;',0,2000);
            error_column := SUBSTRB('"W5_24_S0"',0,80);
            
            BEGIN
              error_value := SUBSTRB("EDW_STUDENT_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */,0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "EDW_STUDENT_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */;
  ...
  last_error_message := SQLERRM;
                  ...
                  "JOINER_ER"('TRACE 2017: ' || error_stmt, error_column, error_value, SQLCODE, SQLERRM, get_audit_detail_id, "JOINER_i");
        ...
        EXCEPTION
          WHEN OTHERS THEN
              last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
            "JOINER_ER"('TRACE 2015: ' || error_stmt, '*', NULL, SQLCODE, SQLERRM, NULL, "JOINER_i");
            get_errors := get_errors + 1;
...
TYPE "T_J1_45_A4$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
...
BEGIN
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_YEAR_LD',0,80),
    p_value=>SUBSTRB("J1_45_A4$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
...
get_target_name := '"WDT_ACADEMIC_TIME"';
            ...
            "J1_45_A4$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_8_A4$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_45_A4$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
  ...
  last_error_message := SQLERRM;
                  ...
                  "JOINER_ER$1"('TRACE 2023: ' || error_stmt, error_column, error_value, SQLCODE, SQLERRM, get_audit_detail_id, "JOINER_i$1");
        ...
        EXCEPTION
          WHEN OTHERS THEN
              last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
            "JOINER_ER$1"('TRACE 2021: ' || error_stmt, '*', NULL, SQLCODE, SQLERRM, NULL, "JOINER_i$1");
            get_errors := get_errors + 1;
            IF get_errors > get_max_errors THEN  
  get_abort := TRUE;
END IF;
...
BEGIN
  ...
  IF NOT (get_audit_level = AUDIT_NONE) THEN
    get_runtime_audit_id := OWBSYS.WB_RT_MAPAUDIT.audit_begin(  -- Template AuditBegin
      ...
      p_parent=>NULL,
      p_source=>'"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_CLEAN"',
      p_source_uoid=>'F14CC01228137D66E040F00AA4443159',
      p_target=>'"WDT_ACADEMIC_TIME"',
      p_target_uoid=>'F14CC012282A7D66E040F00AA4443159',      p_info=>NULL,
...
BEGIN
  ...
  END IF;
        ...
        AND    uo.object_name = 'EDW_STUDENT_DIM_ACAD_TIME'
...
BEGIN
  ...
  IF get_job_audit THEN 
     OWBSYS.wb_rt_mapaudit_util.premap('EDW_STUDENT_DIM_ACAD_TIME', x_schema, x_audit_id, x_object_id);
  ELSE
    OWBSYS.wb_rt_mapaudit_util.set_schema_workspace(x_schema);
  END IF;
