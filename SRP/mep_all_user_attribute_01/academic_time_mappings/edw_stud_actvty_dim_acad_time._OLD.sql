create or replace PACKAGE "EDW_STUD_ACTVTY_DIM_ACAD_TIME"  AS

-- Map Generation Timestamp
get_generation_date      VARCHAR2(100) := 'Fri Jan 31 15:46:08 MST 2014';
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := 'F14CC0123B2D7D66E040F00AA4443159';
get_model_name                CONSTANT VARCHAR2(40) := '"EDW_STUD_ACTVTY_DIM_ACAD_TIME"';
...
"C2_0_S0" VARCHAR2(120) := 'STUDENT_ACTIVITY'; -- ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS

-- Access functions for user-defined variables via mapping Variable components,
--            and package global storage for user-defined mapping input parameters
-- Access function for ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS
FUNCTION "GET_C2_0_S0" RETURN VARCHAR2 DETERMINISTIC PARALLEL_ENABLE;
FUNCTION "GET_C2_0_S0"(owb$p_value VARCHAR2, owb$p_write NUMBER) RETURN VARCHAR2 DETERMINISTIC;
...
-- Function Main -- Entry point in package "EDW_STUD_ACTVTY_DIM_ACAD_TIME"
--------------------------------------------------
...
END "EDW_STUD_ACTVTY_DIM_ACAD_TIME";
/
create or replace PACKAGE BODY "EDW_STUD_ACTVTY_DIM_ACAD_TIME" AS
...
/* JOINER.OUTGRP1 */
  ...
  "INGRP1"."ACADEMIC_YEAR_LD" "ACADEMIC_YEAR_LD_1",
...
/* PIVOT.OUTGRP1 */
  ...
  "PIVOT"."ACADEMIC_YEAR_WV" "ACADEMIC_YEAR",
  "PIVOT"."ACADEMIC_YEAR_SD$1" "ACADEMIC_YEAR_SD",
  "PIVOT"."ACADEMIC_YEAR_LD$1" "ACADEMIC_YEAR_LD"
FROM
  (SELECT
/* OPERATOR PIVOT: TRANSFORM */
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_WV" END "ACADEMIC_PERIOD_WV",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_SD" END "ACADEMIC_PERIOD_SD$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_LD" END "ACADEMIC_PERIOD_LD$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_BEGIN_DATE" END "ACADEMIC_PERIOD_BEGIN_DATE$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_END_DATE" END "ACADEMIC_PERIOD_END_DATE$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_WV" END "ACADEMIC_YEAR_WV",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_SD" END "ACADEMIC_YEAR_SD$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_LD" END "ACADEMIC_YEAR_LD$1"
FROM
  (SELECT
  0 "ID"
FROM
...
FROM
  ...
  (SELECT
/*+ PARALLEL("WTT_STUDENT_ACTIVITY_CLEAN", 8) */
/* WTT_STUDENT_ACTIVITY_CLEAN.INOUTGRP1 */
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_PERIOD_WV" "ACADEMIC_PERIOD_WV",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_PERIOD_SD" "ACADEMIC_PERIOD_SD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_PERIOD_LD" "ACADEMIC_PERIOD_LD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_PERIOD_BEGIN_DATE" "ACADEMIC_PERIOD_BEGIN_DATE",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_PERIOD_END_DATE" "ACADEMIC_PERIOD_END_DATE",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_YEAR_WV" "ACADEMIC_YEAR_WV",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_YEAR_SD" "ACADEMIC_YEAR_SD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."ACADEMIC_YEAR_LD" "ACADEMIC_YEAR_LD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_PERIOD_WV" "F_ACADEMIC_PERIOD_WV",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_PERIOD_SD" "F_ACADEMIC_PERIOD_SD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_PERIOD_LD" "F_ACADEMIC_PERIOD_LD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_PERIOD_BEGIN_DATE" "F_ACADEMIC_PERIOD_BEGIN_DATE",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_PERIOD_END_DATE" "F_ACADEMIC_PERIOD_END_DATE",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_YEAR_WV" "F_ACADEMIC_YEAR_WV",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_YEAR_SD" "F_ACADEMIC_YEAR_SD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."F_ACADEMIC_YEAR_LD" "F_ACADEMIC_YEAR_LD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_PERIOD_WV" "L_ACADEMIC_PERIOD_WV",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_PERIOD_SD" "L_ACADEMIC_PERIOD_SD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_PERIOD_LD" "L_ACADEMIC_PERIOD_LD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_PERIOD_BEGIN_DATE" "L_ACADEMIC_PERIOD_BEGIN_DATE",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_PERIOD_END_DATE" "L_ACADEMIC_PERIOD_END_DATE",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_YEAR_WV" "L_ACADEMIC_YEAR_WV",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_YEAR_SD" "L_ACADEMIC_YEAR_SD",
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_YEAR_LD" "L_ACADEMIC_YEAR_LD"
FROM
  "EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"  "WTT_STUDENT_ACTIVITY_CLEAN") "PIVOT_SOURCE" /* OPERATOR PIVOT */) "PIVOT" 
...
/* SET_OPERATION.OUTGRP1 */
  ...
  "SET_OPERATION$1"."ACADEMIC_YEAR$1" "ACADEMIC_YEAR",
...
/* PIVOT.OUTGRP1 */
  ...
  "PIVOT$1"."ACADEMIC_YEAR_WV$1" "ACADEMIC_YEAR",
  "PIVOT$1"."ACADEMIC_YEAR_SD$3" "ACADEMIC_YEAR_SD",
  "PIVOT$1"."ACADEMIC_YEAR_LD$3" "ACADEMIC_YEAR_LD"
FROM
  (SELECT
/* OPERATOR PIVOT: TRANSFORM */
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_WV" END "ACADEMIC_PERIOD_WV$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_SD" END "ACADEMIC_PERIOD_SD$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_LD" END "ACADEMIC_PERIOD_LD$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_BEGIN_DATE" END "ACADEMIC_PERIOD_BEGIN_DATE$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_END_DATE" END "ACADEMIC_PERIOD_END_DATE$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_WV" END "ACADEMIC_YEAR_WV$1",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_SD" END "ACADEMIC_YEAR_SD$3",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_LD" END "ACADEMIC_YEAR_LD$3"
FROM
  (SELECT
  0 "ID"
FROM
...
/* WTT_STUDENT_ACTIVITY_CLEAN.INOUTGRP1 */
  ...
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_YEAR_LD" "L_ACADEMIC_YEAR_LD"
FROM
  "EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"  "WTT_STUDENT_ACTIVITY_CLEAN") "PIVOT_SOURCE" /* OPERATOR PIVOT */) "PIVOT$1" 
MINUS /* OPERATOR SET_OPERATION */
SELECT
/* WDT_ACADEMIC_TIME_1.INOUTGRP1 */
  "WDT_ACADEMIC_TIME_1"."ACADEMIC_PERIOD" "ACADEMIC_PERIOD",
...
--            and package global storage for user-defined mapping input parameters
-- Access function for ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS
FUNCTION "GET_C2_0_S0" RETURN VARCHAR2 IS
BEGIN
  RETURN "C2_0_S0";
END "GET_C2_0_S0";
FUNCTION "GET_C2_0_S0"(owb$p_value VARCHAR2, owb$p_write NUMBER) RETURN VARCHAR2 IS
BEGIN
...
BEGIN
  ...
  get_abort_procedure := FALSE;
    ...
    batch_auditd_id := OWBSYS.WB_RT_MAPAUDIT.auditd_begin(  -- Template BatchAuditDetailBegin
      ...
      p_target_uoid=>'F14CC0123C027D66E040F00AA4443159',
    ...
    p_parent_operator_uoid=>'F14CC0123C027D66E040F00AA4443159', -- Operator WDT_ACADEMIC_TIME
    ...
    p_location_uoid=>'F085808747B70042E040F00AA4445414' -- Location EDWMGR_LOCATION
    	...
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'8BEBF215ECD009B9E0440003BAAC9CF3', -- Operator WTT_STUDENT_ACTIVITY_CLEAN
    p_parent_object_name=>'WTT_STUDENT_ACTIVITY_CLEAN',
    p_parent_object_uoid=>'89A121B8A1B45DA0E0440003BAAC9CF3', -- Table WTT_STUDENT_ACTIVITY_CLEAN
    p_parent_object_type=>'Table',
    p_object_name=>'WTT_STUDENT_ACTIVITY_CLEAN',
    p_object_uoid=>'89A121B8A1B45DA0E0440003BAAC9CF3', -- Table WTT_STUDENT_ACTIVITY_CLEAN
    p_object_type=>'Table',
    p_location_uoid=>'8848749C75B34564E0440003BAAC9CF3' -- EDWSTG_LOCATION
  );
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'DC0A16EC16A130ACE04356251895DF0D', -- Operator WCV_DEFAULT_VALUES
    ...
    p_location_uoid=>'ADA0B2222EF50292E040189556257D87' -- EDWSTG_LOCATION
    	...
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'F14CC0123C797D66E040F00AA4443159', -- Operator WTT_STUDENT_ACTIVITY_CLEAN
    p_parent_object_name=>'WTT_STUDENT_ACTIVITY_CLEAN',
    p_parent_object_uoid=>'F085A95885339205E040F00AA444128A', -- Table WTT_STUDENT_ACTIVITY_CLEAN
    p_parent_object_type=>'Table',
    p_object_name=>'WTT_STUDENT_ACTIVITY_CLEAN',
    p_object_uoid=>'F085A95885339205E040F00AA444128A', -- Table WTT_STUDENT_ACTIVITY_CLEAN
    p_object_type=>'Table',
    p_location_uoid=>'F085808747D20042E040F00AA4445414' -- Location EDWSTG_LOCATION
  );
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'89A121B8C6215DA0E0440003BAAC9CF3', -- Operator WDT_ACADEMIC_TIME
    p_parent_object_name=>'WDT_ACADEMIC_TIME',
    ...
    p_location_uoid=>'8848749C75C84564E0440003BAAC9CF3' -- EDWMGR_LOCATION
    	...
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'F14CC0123BEB7D66E040F00AA4443159', -- Operator WCV_DEFAULT_VALUES
    p_parent_object_name=>'WCV_DEFAULT_VALUES',
...
MERGE
/*+ APPEND PARALLEL("WDT_ACADEMIC_TIME") */
INTO
...
/* JOINER.OUTGRP1 */
  ...
  "INGRP1"."ACADEMIC_YEAR" "ACADEMIC_YEAR$2",
  ...
  "WCV_DEFAULT_VALUES"."NULL_CLEANSE_SHORT" "USER_ATTRIBUTE_05_SD",
  "WCV_DEFAULT_VALUES"."NULL_CLEANSE_LONG" "USER_ATTRIBUTE_05_LD",
  "EDW_STUD_ACTVTY_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */ "SYSTEM_LOAD_PROCESS",
...
/* SET_OPERATION.OUTGRP1 */
  ...
  "SET_OPERATION$2"."ACADEMIC_YEAR$3" "ACADEMIC_YEAR",
  "SET_OPERATION$2"."ACADEMIC_YEAR_SD$5" "ACADEMIC_YEAR_SD",
  "SET_OPERATION$2"."ACADEMIC_YEAR_LD$4" "ACADEMIC_YEAR_LD"
FROM
  (SELECT
  ...
  "ACADEMIC_YEAR_LD" "ACADEMIC_YEAR_LD$4"
FROM
  (SELECT
/* PIVOT.OUTGRP1 */
  ...
  "PIVOT$2"."ACADEMIC_YEAR_WV$2" "ACADEMIC_YEAR",
  "PIVOT$2"."ACADEMIC_YEAR_SD$6" "ACADEMIC_YEAR_SD",
  "PIVOT$2"."ACADEMIC_YEAR_LD$5" "ACADEMIC_YEAR_LD"
FROM
  (SELECT
/* OPERATOR PIVOT: TRANSFORM */
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_WV" END "ACADEMIC_PERIOD_WV$2",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_SD" END "ACADEMIC_PERIOD_SD$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_LD" END "ACADEMIC_PERIOD_LD$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_BEGIN_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_BEGIN_DATE" END "ACADEMIC_PERIOD_BEGIN_DATE$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_PERIOD_END_DATE" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_PERIOD_END_DATE" END "ACADEMIC_PERIOD_END_DATE$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_WV" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_WV" END "ACADEMIC_YEAR_WV$2",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_SD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_SD" END "ACADEMIC_YEAR_SD$6",
  CASE WHEN "PIVOT_ROW_GENERATOR"."ID" = 0 THEN "PIVOT_SOURCE"."ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 1 THEN "PIVOT_SOURCE"."F_ACADEMIC_YEAR_LD" WHEN "PIVOT_ROW_GENERATOR"."ID" = 2 THEN "PIVOT_SOURCE"."L_ACADEMIC_YEAR_LD" END "ACADEMIC_YEAR_LD$5"
FROM
  (SELECT
  0 "ID"
FROM
...
/* WTT_STUDENT_ACTIVITY_CLEAN.INOUTGRP1 */
  ...
  "WTT_STUDENT_ACTIVITY_CLEAN"."L_ACADEMIC_YEAR_LD" "L_ACADEMIC_YEAR_LD"
FROM
  "EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"  "WTT_STUDENT_ACTIVITY_CLEAN") "PIVOT_SOURCE" /* OPERATOR PIVOT */) "PIVOT$2" 
MINUS /* OPERATOR SET_OPERATION */
SELECT
/* WDT_ACADEMIC_TIME_1.INOUTGRP1 */
  "WDT_ACADEMIC_TIME_1"."ACADEMIC_PERIOD" "ACADEMIC_PERIOD",
...
ON (
  ...
  "WDT_ACADEMIC_TIME"."ACADEMIC_YEAR" = "MERGE_SUBQUERY"."ACADEMIC_YEAR$2" AND
  ...
  "ACADEMIC_YEAR_LD" = "MERGE_SUBQUERY"."ACADEMIC_YEAR_LD_1",
  ...
  WHEN NOT MATCHED THEN
    ...
    VALUES
      ...
      "MERGE_SUBQUERY"."ACADEMIC_YEAR$2",
      "MERGE_SUBQUERY"."ACADEMIC_YEAR_SD$4",
      "MERGE_SUBQUERY"."ACADEMIC_YEAR_LD_1",
...
IF NOT batch_exception AND NOT get_no_commit THEN
      ...
      IF actual_name IS NOT NULL THEN
        ...
        IF (batch_inserted + batch_merged) >= get_map_num_rows THEN
          ...
          "EDW_STUD_ACTVTY_DIM_ACAD_TIME".tables_to_analyze(
        "EDW_STUD_ACTVTY_DIM_ACAD_TIME".tables_to_analyze.COUNT + 1) := a_table_to_analyze;
        END IF;
      END IF;
    END IF;
...
get_source_name            CONSTANT VARCHAR2(2000) := SUBSTRB('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,2000);
get_source_uoid            CONSTANT VARCHAR2(2000) := SUBSTRB('F14CC0123BEB7D66E040F00AA4443159',0,2000);
...
TYPE "T_J1_38_A9" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_ROWKEY_JOINER" IS TABLE OF VARCHAR2(18) INDEX BY BINARY_INTEGER;
TYPE "T_J1_39_A9" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_40_A2" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_41_A2" IS TABLE OF DATE INDEX BY BINARY_INTEGER;
TYPE "T_J1_42_A6" IS TABLE OF DATE INDEX BY BINARY_INTEGER;
TYPE "T_J1_43_A1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_44_A1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_45_A6" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_23_U2" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_24_U6" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_25_U9" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_26_U3" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_27_U7" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_28_U0" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_29_U4" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_30_U8" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_31_U1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_32_U5" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_33_U9" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_34_U2" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_35_U6" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_36_U0" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_37_U3" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
...
"SV_J1_38_A9"  VARCHAR2(252);
"SV_ROWKEY_JOINER"  VARCHAR2(18);
"SV_J1_39_A9"  VARCHAR2(1020);
"SV_J1_40_A2"  VARCHAR2(1020);
"SV_J1_41_A2"  DATE;
"SV_J1_42_A6"  DATE;
"SV_J1_43_A1"  VARCHAR2(252);
"SV_J1_44_A1"  VARCHAR2(1020);
"SV_J1_45_A6"  VARCHAR2(1020);
"SV_J1_23_U2"  VARCHAR2(252);
"SV_J1_24_U6"  VARCHAR2(1020);
"SV_J1_25_U9"  VARCHAR2(1020);
"SV_J1_26_U3"  VARCHAR2(252);
"SV_J1_27_U7"  VARCHAR2(1020);
"SV_J1_28_U0"  VARCHAR2(1020);
"SV_J1_29_U4"  VARCHAR2(252);
"SV_J1_30_U8"  VARCHAR2(1020);
"SV_J1_31_U1"  VARCHAR2(1020);
"SV_J1_32_U5"  VARCHAR2(252);
"SV_J1_33_U9"  VARCHAR2(1020);
"SV_J1_34_U2"  VARCHAR2(1020);
"SV_J1_35_U6"  VARCHAR2(252);
"SV_J1_36_U0"  VARCHAR2(1020);
"SV_J1_37_U3"  VARCHAR2(1020);
...
BEGIN
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_seq=>1,
    p_instance=>1,
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_PERIOD',0,80),
    p_value=>SUBSTRB("J1_38_A9"(error_index),0,2000),
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_39_A9"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_40_A2"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_41_A2"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_42_A6"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_43_A1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_44_A1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_instance=>1,
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_YEAR_LD_1',0,80),
    p_value=>SUBSTRB("J1_45_A6"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_23_U2"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_24_U6"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_25_U9"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_26_U3"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_27_U7"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_28_U0"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_29_U4"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_30_U8"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_31_U1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_32_U5"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_34_U2"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_35_U6"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_value=>SUBSTRB("J1_37_U3"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  RETURN;
...
BEGIN
  ...
  BEGIN
    ...
    get_total_processed_rowcount := get_total_processed_rowcount + "J1_38_A9".COUNT;

    IF "JOINER_c"%NOTFOUND AND "J1_38_A9".COUNT = 0 THEN
      RETURN;
    END IF;
    -- register feedback for successful reads
    IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
      get_rowkey := rowkey_counter;
      rowkey_counter := rowkey_counter + "J1_38_A9".COUNT;
    END IF;
    ...
    END IF;
    get_map_selected := get_map_selected + "J1_38_A9".COUNT;
  EXCEPTION
    WHEN OTHERS THEN
        last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
    ...
    IF NOT get_abort AND NOT get_abort_procedure THEN
      ...
      LOOP
        IF "JOINER_si" = 0 THEN
          ...
          IF NOT get_read_success THEN
            bulk_count := "J1_38_A9".COUNT - 1;
          ELSE
            bulk_count := "J1_38_A9".COUNT;
          END IF;
                                        IF bulk_commit THEN
                                                bulk_commit_count := 0;
                                                bulk_commit := FALSE;
...
get_target_name := '"WDT_ACADEMIC_TIME"';
            ...
            "J1_38_A9"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_1_A9"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_38_A9"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_39_A9"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_2_A9"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_39_A9"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_40_A2"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_3_A2"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_40_A2"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_41_A2"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_4_A2"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_41_A2"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_42_A6"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_5_A6"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_42_A6"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_43_A1"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_6_A1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_43_A1"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_44_A1"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_7_A1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_44_A1"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_45_A6"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_8_A4"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_45_A6"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_23_U2"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_9_U2"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_23_U2"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_24_U6"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_10_U6"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_24_U6"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_25_U9"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_11_U9"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_25_U9"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_26_U3"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_12_U3"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_26_U3"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_27_U7"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_13_U7"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_27_U7"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_28_U0"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_14_U0"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_28_U0"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_29_U4"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_15_U4"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_29_U4"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_30_U8"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_16_U8"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_30_U8"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_31_U1"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_17_U1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_31_U1"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_32_U5"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_18_U5"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_32_U5"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_34_U2"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_20_U2"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_34_U2"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_35_U6"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_21_U6"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_35_U6"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_37_U3"("JOINER_i");',0,2000);
            error_column := SUBSTRB('"W5_23_U3"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_37_U3"("JOINER_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "EDW_STUD_ACTVTY_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */;',0,2000);
            error_column := SUBSTRB('"W5_24_S0"',0,80);
            
            BEGIN
              error_value := SUBSTRB("EDW_STUD_ACTVTY_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */,0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "EDW_STUD_ACTVTY_DIM_ACAD_TIME"."C2_0_S0"/* ATTRIBUTE CONSTANT.OUTGRP1.SYSTEM_LOAD_PROCESS */;
  ...
  last_error_message := SQLERRM;
                  ...
                  "JOINER_ER"('TRACE 1961: ' || error_stmt, error_column, error_value, SQLCODE, SQLERRM, get_audit_detail_id, "JOINER_i");
        ...
        EXCEPTION
          WHEN OTHERS THEN
              last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
            "JOINER_ER"('TRACE 1959: ' || error_stmt, '*', NULL, SQLCODE, SQLERRM, NULL, "JOINER_i");
            get_errors := get_errors + 1;
...
-- Bulk: types for collection variables
TYPE "T_J1_38_A9$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_ROWKEY_JOINER$1" IS TABLE OF VARCHAR2(18) INDEX BY BINARY_INTEGER;
TYPE "T_J1_39_A9$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_40_A2$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_41_A2$1" IS TABLE OF DATE INDEX BY BINARY_INTEGER;
TYPE "T_J1_42_A6$1" IS TABLE OF DATE INDEX BY BINARY_INTEGER;
TYPE "T_J1_43_A1$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_44_A1$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_45_A6$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_23_U2$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_24_U6$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_25_U9$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_26_U3$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_27_U7$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_28_U0$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_29_U4$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_30_U8$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_31_U1$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_32_U5$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_33_U9$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_34_U2$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_35_U6$1" IS TABLE OF VARCHAR2(252) INDEX BY BINARY_INTEGER;
TYPE "T_J1_36_U0$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
TYPE "T_J1_37_U3$1" IS TABLE OF VARCHAR2(1020) INDEX BY BINARY_INTEGER;
...
-- Bulk: intermediate scalar variables
"SV_J1_38_A9$1"  VARCHAR2(252);
"SV_ROWKEY_JOINER$1"  VARCHAR2(18);
"SV_J1_39_A9$1"  VARCHAR2(1020);
"SV_J1_40_A2$1"  VARCHAR2(1020);
"SV_J1_41_A2$1"  DATE;
"SV_J1_42_A6$1"  DATE;
"SV_J1_43_A1$1"  VARCHAR2(252);
"SV_J1_44_A1$1"  VARCHAR2(1020);
"SV_J1_45_A6$1"  VARCHAR2(1020);
"SV_J1_23_U2$1"  VARCHAR2(252);
"SV_J1_24_U6$1"  VARCHAR2(1020);
"SV_J1_25_U9$1"  VARCHAR2(1020);
"SV_J1_26_U3$1"  VARCHAR2(252);
"SV_J1_27_U7$1"  VARCHAR2(1020);
"SV_J1_28_U0$1"  VARCHAR2(1020);
"SV_J1_29_U4$1"  VARCHAR2(252);
"SV_J1_30_U8$1"  VARCHAR2(1020);
"SV_J1_31_U1$1"  VARCHAR2(1020);
"SV_J1_32_U5$1"  VARCHAR2(252);
"SV_J1_33_U9$1"  VARCHAR2(1020);
"SV_J1_34_U2$1"  VARCHAR2(1020);
"SV_J1_35_U6$1"  VARCHAR2(252);
"SV_J1_36_U0$1"  VARCHAR2(1020);
"SV_J1_37_U3$1"  VARCHAR2(1020);
...
-- Bulk: intermediate collection variables
"J1_38_A9$1" "T_J1_38_A9$1";
"ROWKEY_JOINER$1" "T_ROWKEY_JOINER$1";
"J1_39_A9$1" "T_J1_39_A9$1";
"J1_40_A2$1" "T_J1_40_A2$1";
"J1_41_A2$1" "T_J1_41_A2$1";
"J1_42_A6$1" "T_J1_42_A6$1";
"J1_43_A1$1" "T_J1_43_A1$1";
"J1_44_A1$1" "T_J1_44_A1$1";
"J1_45_A6$1" "T_J1_45_A6$1";
"J1_23_U2$1" "T_J1_23_U2$1";
"J1_24_U6$1" "T_J1_24_U6$1";
"J1_25_U9$1" "T_J1_25_U9$1";
"J1_26_U3$1" "T_J1_26_U3$1";
"J1_27_U7$1" "T_J1_27_U7$1";
"J1_28_U0$1" "T_J1_28_U0$1";
"J1_29_U4$1" "T_J1_29_U4$1";
"J1_30_U8$1" "T_J1_30_U8$1";
"J1_31_U1$1" "T_J1_31_U1$1";
"J1_32_U5$1" "T_J1_32_U5$1";
"J1_33_U9$1" "T_J1_33_U9$1";
"J1_34_U2$1" "T_J1_34_U2$1";
"J1_35_U6$1" "T_J1_35_U6$1";
"J1_36_U0$1" "T_J1_36_U0$1";
"J1_37_U3$1" "T_J1_37_U3$1";
...
BEGIN
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_PERIOD',0,80),
    p_value=>SUBSTRB("J1_38_A9$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_PERIOD_SD',0,80),
    p_value=>SUBSTRB("J1_39_A9$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_PERIOD_LD',0,80),
    p_value=>SUBSTRB("J1_40_A2$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_PERIOD_BEGIN_DATE',0,80),
    p_value=>SUBSTRB("J1_41_A2$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_PERIOD_END_DATE',0,80),
    p_value=>SUBSTRB("J1_42_A6$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_YEAR',0,80),
    p_value=>SUBSTRB("J1_43_A1$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_YEAR_SD',0,80),
    p_value=>SUBSTRB("J1_44_A1$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('ACADEMIC_YEAR_LD_1',0,80),
    p_value=>SUBSTRB("J1_45_A6$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_01',0,80),
    p_value=>SUBSTRB("J1_23_U2$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_01_SD',0,80),
    p_value=>SUBSTRB("J1_24_U6$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_01_LD',0,80),
    p_value=>SUBSTRB("J1_25_U9$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_02',0,80),
    p_value=>SUBSTRB("J1_26_U3$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_02_SD',0,80),
    p_value=>SUBSTRB("J1_27_U7$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_02_LD',0,80),
    p_value=>SUBSTRB("J1_28_U0$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_03',0,80),
    p_value=>SUBSTRB("J1_29_U4$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_03_SD',0,80),
    p_value=>SUBSTRB("J1_30_U8$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_03_LD',0,80),
    p_value=>SUBSTRB("J1_31_U1$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_04',0,80),
    p_value=>SUBSTRB("J1_32_U5$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_04_LD',0,80),
    p_value=>SUBSTRB("J1_34_U2$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_05',0,80),
    p_value=>SUBSTRB("J1_35_U6$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  OWBSYS.WB_RT_MAPAUDIT.error_source(
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',0,80),
    p_column=>SUBSTR('USER_ATTRIBUTE_05_LD',0,80),
    p_value=>SUBSTRB("J1_37_U3$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  RETURN;
...
BEGIN
  ...
  BEGIN
    ...
    get_total_processed_rowcount := get_total_processed_rowcount + "J1_38_A9$1".COUNT;

    IF "JOINER_c$1"%NOTFOUND AND "J1_38_A9$1".COUNT = 0 THEN
      RETURN;
    END IF;
    -- register feedback for successful reads
    IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
      get_rowkey := rowkey_counter;
      rowkey_counter := rowkey_counter + "J1_38_A9$1".COUNT;
    END IF;
    ...
    END IF;
    get_map_selected := get_map_selected + "J1_38_A9$1".COUNT;
  EXCEPTION
    WHEN OTHERS THEN
        last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
    ...
    IF NOT get_abort AND NOT get_abort_procedure THEN
      ...
      LOOP
        IF "JOINER_si$1" = 0 THEN
          ...
          IF NOT get_read_success THEN
            bulk_count := "J1_38_A9$1".COUNT - 1;
          ELSE
            bulk_count := "J1_38_A9$1".COUNT;
          END IF;
                                        IF bulk_commit THEN
                                                bulk_commit_count := 0;
                                                bulk_commit := FALSE;
...
get_target_name := '"WDT_ACADEMIC_TIME"';
            ...
            "J1_38_A9$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_1_A9$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_38_A9$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_39_A9$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_2_A9$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_39_A9$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_40_A2$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_3_A2$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_40_A2$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_41_A2$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_4_A2$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_41_A2$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_42_A6$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_5_A6$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_42_A6$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_43_A1$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_6_A1$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_43_A1$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_44_A1$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_7_A1$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_44_A1$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_45_A6$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_8_A4$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_45_A6$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_23_U2$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_9_U2$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_23_U2$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_24_U6$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_10_U6$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_24_U6$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_25_U9$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_11_U9$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_25_U9$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_26_U3$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_12_U3$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_26_U3$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_27_U7$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_13_U7$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_27_U7$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_28_U0$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_14_U0$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_28_U0$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_29_U4$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_15_U4$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_29_U4$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_30_U8$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_16_U8$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_30_U8$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_31_U1$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_17_U1$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_31_U1$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_32_U5$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_18_U5$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_32_U5$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_34_U2$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_20_U2$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_34_U2$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_35_U6$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_21_U6$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_35_U6$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            "J1_37_U3$1"("JOINER_i$1");',0,2000);
            error_column := SUBSTRB('"W5_23_U3$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("J1_37_U3$1"("JOINER_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
  ...
  last_error_message := SQLERRM;
                  ...
                  "JOINER_ER$1"('TRACE 1967: ' || error_stmt, error_column, error_value, SQLCODE, SQLERRM, get_audit_detail_id, "JOINER_i$1");
        ...
        EXCEPTION
          WHEN OTHERS THEN
              last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
            "JOINER_ER$1"('TRACE 1965: ' || error_stmt, '*', NULL, SQLCODE, SQLERRM, NULL, "JOINER_i$1");
            get_errors := get_errors + 1;
            IF get_errors > get_max_errors THEN  
  get_abort := TRUE;
END IF;
...
BEGIN
  ...
  IF NOT (get_audit_level = AUDIT_NONE) THEN
    get_runtime_audit_id := OWBSYS.WB_RT_MAPAUDIT.audit_begin(  -- Template AuditBegin
      ...
      p_parent=>NULL,
      p_source=>'"EDWSTG"."WCV_DEFAULT_VALUES",DUAL,"EDWSTG"."WTT_STUDENT_ACTIVITY_CLEAN"',
      p_source_uoid=>'F14CC0123BEB7D66E040F00AA4443159',
      p_target=>'"WDT_ACADEMIC_TIME"',
      p_target_uoid=>'F14CC0123C027D66E040F00AA4443159',      p_info=>NULL,
...
BEGIN
  ...
  END IF;
        ...
        AND    uo.object_name = 'EDW_STUD_ACTVTY_DIM_ACAD_TIME'
...
BEGIN
  ...
  IF get_job_audit THEN 
     OWBSYS.wb_rt_mapaudit_util.premap('EDW_STUD_ACTVTY_DIM_ACAD_TIME', x_schema, x_audit_id, x_object_id);
  ELSE
    OWBSYS.wb_rt_mapaudit_util.set_schema_workspace(x_schema);
  END IF;
